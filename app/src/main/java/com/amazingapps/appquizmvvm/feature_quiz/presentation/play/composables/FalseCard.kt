        ...
        Column(
            ...
            Card(modifier.fillMaxWidth().padding(horizontal = 8.dp)) {
                Column(modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                    Image(
                        painter = painterResource(R.drawable.capisad),
                        contentDescription = "Incorrect Anwser",
                        modifier = Modifier.size(300.dp)
                    )
                    Text("Resposta Incorrecta!", fontSize = 19.sp)
                    Text("Resposta correcte:")
                    Text(correct, textAlign = TextAlign.Center, fontSize = 21.sp, fontFamily = FontFamily.Serif)
                    ButtonMain(
                        text = "continuar",
                        onclick = {
                            buttonOnClick()
